            ...
            if res[report.id].get('account'):
                ...
                for account_id, value in res[report.id]['account'].items():
                    ...
                    if data['debit_credit']:
                        ...
                        if not account.sudo().company_id.currency_id.is_zero(vals['debit']) or not account.sudo().company_id.currency_id.is_zero(vals['credit']):
                            flag = True
                    if not account.sudo().company_id.currency_id.is_zero(vals['balance']):
                        flag = True
                    if data['enable_filter']:
                        vals['balance_cmp'] = value['comp_bal'] * report.sign
                        if not account.sudo().company_id.currency_id.is_zero(vals['balance_cmp']):
                            flag = True
                    if flag:
